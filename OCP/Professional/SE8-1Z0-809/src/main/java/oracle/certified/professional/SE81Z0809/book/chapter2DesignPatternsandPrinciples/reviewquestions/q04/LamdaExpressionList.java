package oracle.certified.professional.SE81Z0809.book.chapter2DesignPatternsandPrinciples.reviewquestions.q04;
...
public class LamdaExpressionList {
    ...
    public static void main(String ... args) {
       ...
       // a(); //Error:(3,31) java: package jdk.management.resource does not exist
        b();
        c();
        d();
        e();
