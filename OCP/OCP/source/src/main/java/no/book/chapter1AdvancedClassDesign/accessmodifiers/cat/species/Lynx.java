...
public class Lynx extends BigCat {
    ...
    public static void main(String ... args) {
        ...
        // Error: java: hasPaws is not public in no.book.chapter1AdvancedClassDesign.accessmodifiers.cat.BigCat; cannot be accessed from outside package
        ...
        // Error:(39, 21) java: incompatible types: no.book.chapter1AdvancedClassDesign.accessmodifiers.cat.BigCat cannot be converted to no.book.chapter1AdvancedClassDesign.accessmodifiers.cat.species.Lynx
