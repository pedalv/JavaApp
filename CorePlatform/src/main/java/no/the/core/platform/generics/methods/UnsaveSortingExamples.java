...
import no.the.core.platform.generics.classesinterfaces.ReverseComparator;
import no.the.core.platform.generics.classesinterfaces.Reverser;
...
public class UnsaveSortingExamples
{
    public static void main(String[] args)
    {
        ...
        // cast problems - solution: add generics
