...
package com.bookcontract.schema.order;
 ...
 * generated in the com.bookcontract.schema.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderInquiry_QNAME = new QName("http://www.bookcontract.com/schema/Order", "orderInquiry");
    private final static QName _OrderInquiryResponse_QNAME = new QName("http://www.bookcontract.com/schema/Order", "orderInquiryResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bookcontract.schema.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bookcontract.com/schema/Order", name = "orderInquiry")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bookcontract.com/schema/Order", name = "orderInquiryResponse")
