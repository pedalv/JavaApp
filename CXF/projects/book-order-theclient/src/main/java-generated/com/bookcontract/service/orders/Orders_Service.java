 ...
 * 2018-01-24T10:35:20.019+01:00
 * Generated source version: 3.1.13
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "http://localhost:8080/book-order/services/orders?wsdl",
...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/book-order/services/orders?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/book-order/services/orders?wsdl");
        }
        WSDL_LOCATION = url;
    }
